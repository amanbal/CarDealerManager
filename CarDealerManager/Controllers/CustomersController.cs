...
namespace CarDealerManager.Controllers
{
    ...
    public class CustomersController : Controller
    {
        ...
        public CustomersController(CarDealerManagerCREDContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Address,Email,Phone")] Customer customer)
        {
            if (id != customer.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            }catch (Exception ex)
            {
                ...
                ErrorMessageHandler.CustomErrorMessagePart1 = "If data is not deleted we recomend you to first delete this customer from store";
